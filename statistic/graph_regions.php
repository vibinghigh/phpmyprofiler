...
if ( $pmp_thumbnail_cache && is_file('../cache/graph_regions_'.$_SESSION['lang_id'].'.png') ) {
    $filename = '../cache/graph_regions_'.$_SESSION['lang_id'].'.png';
	...
	// Setup the graph
	$graph = new Graph(550, (12*$rows+40), 'graph_regions_'.$_SESSION['lang_id'].'.png');
