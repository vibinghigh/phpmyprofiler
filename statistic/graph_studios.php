...
if ( $pmp_thumbnail_cache && is_file('../cache/graph_studios_'.$_SESSION['lang_id'].'.png') ) {
    $filename = '../cache/graph_studios_'.$_SESSION['lang_id'].'.png';
	...
	// Setup the graph
	$graph = new Graph(550, 160, 'graph_studios_'.$_SESSION['lang_id'].'.png');
